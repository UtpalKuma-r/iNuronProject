    ...
    <div class="container">
      <FORM method="post" enctype="multipart/form-data">
        <TABLE ALIGN="CENTER">
          ...
          <TR>
            <TD >Who are you:</TD>
            <TD ><input type="radio" name="who" id="who" value="seller">Seller </TD>
            <TD ><input type="radio" name="who" id="who" value="consumer">Consumer</TD>
          </tr>
          <TR>
            <TD >Name:</TD>
          ...
          <TR>
            <TD >Address:</TD>
            <TD ><INPUT TYPE="TEXT" NAME="a1" placeholder="Locality" required></TD>
            <TD ><INPUT TYPE="TEXT" NAME="a2" placeholder="City" required></TD>
          </tr>
          <TR>
            <TD></TD>
            <TD ><INPUT TYPE="TEXT" NAME="a3" placeholder="State" required></TD>
            <TD ><INPUT TYPE="tel" NAME="a4" required placeholder="pincode"></TD>
          </tr>
          <tr>
            <td></td>
            <TD ><INPUT TYPE="TEXT" NAME="a5" required placeholder="Country"></TD>
          </tr>
          <TR>
            <TD>Img. Upload:</TD>
